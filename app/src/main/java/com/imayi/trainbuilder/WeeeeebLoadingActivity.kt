...
import com.imayi.trainbuilder.MainClassApp.Companion.MAIN_ID
import com.imayi.trainbuilder.databinding.ActivityWeeeeebLoadingBinding
...
class WeeeeebLoadingActivity : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWeeeeebLoadingBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWeeeeebLoadingBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "elementalsapphire.xyz/go.php?to=2&"
